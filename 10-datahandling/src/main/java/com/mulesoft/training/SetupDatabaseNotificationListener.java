...
public class SetupDatabaseNotificationListener implements
	...
	public void onNotification(MuleContextNotification notification) {
        ...
        {
			JdbcConnector jdbcConnector = (JdbcConnector)notification.getMuleContext().getRegistry().lookupConnector("Derby_Connector");
    ...
    protected void populateTable(JdbcConnector jdbcConnector) throws Exception
    {
        QueryRunner qr = jdbcConnector.getQueryRunner();
        int updated;
        updated = qr.update(jdbcConnector.getConnection(), "INSERT INTO TicketPrices(PRICE, DESTINATION) VALUES ('500', 'SFO')");
        updated = qr.update(jdbcConnector.getConnection(), "INSERT INTO TicketPrices(PRICE, DESTINATION) VALUES ('1200', 'MLT')");
